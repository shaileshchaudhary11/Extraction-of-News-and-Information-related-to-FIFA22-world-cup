...
#from e2_tkLastFiveMatch import tokens

my_List = []

def p_init(p):
    '''init : bskip BEGINTABLE handleDiv ENDTABLE
            | bskip BEGINTABLE OPENHREF CONTENT CLOSEHREF handleDiv ENDTABLE'''
# #staring rule
# def p_begTable(p):
...
print("<---LAST FIVE MATCHES PLAYED--->")

# Iterate over the list in pairs using the zip function
for x, y in zip(last_10[::2], last_10[1::2]):
    print(x,"vs", y)
