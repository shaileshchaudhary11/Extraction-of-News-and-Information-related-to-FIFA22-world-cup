...
matches = [list[1]+list[2]+list[3],list[12]+list[13]+list[14],list[25]+list[26]+list[27],list[36]+list[37]+list[38],list[48]+list[49]+list[50],list[59]+list[60]+list[61]]
players = [list[0],list[10]+list[11],list[21]+list[22]+list[23]+list[24],list[34]+list[35],list[45]+list[46]+list[47],list[57]+list[58]]
details = [list[4]+list[5]+list[6]+list[7]+list[8]+list[9],list[15]+list[16]+list[17]+list[18]+list[19]+list[20],list[28]+list[29]+list[30]+list[31]+list[32]+list[33],list[39]+list[40]+list[41]+list[42]+list[43]+list[44],list[51]+list[52]+list[53]+list[54]+list[55]+list[56],list[62]+list[63]+list[64]+list[65]+list[66]+list[67]]

# ['Valencia', 'Qatar', '0–2', 'Ecuador', 'Al Bayt Stadium', ', ', 'Al Khor', 'Attendance: 67,372', 'Referee: ', 'Daniele Orsato',||| 
# 
# 'Klaassen', 'Gakpo', 'Senegal', '0–2', 'Netherlands', 'Al Thumama Stadium', ', ', 'Doha', 'Attendance: 41,721', 'Referee: ', 'Wilton Sampaio', |||
# 
#  'Muntari', 'B. Dieng', 'Diédhiou', 'Dia', 'Qatar', '1–3', 'Senegal', 'Al Thumama Stadium', ', ', 'Doha', 'Attendance: 41,797', 'Referee: ', 'Antonio Mateu Lahoz', 34//  
# 'Gakpo', 'Valencia', 'Netherlands', '1–1', 'Ecuador', 'Khalifa International Stadium', ', ', 'Al Rayyan', 'Attendance: 44,833', 'Referee: ', 'Mustapha Ghorbal', 44||| 
# 'Caicedo', 'Koulibaly', 'I. Sarr', 'Ecuador', '1–2', 'Senegal', 'Khalifa International Stadium', ', ', 'Al Rayyan', 'Attendance: 44,569', 'Referee: ', 'Clément Turpin', 56||| 
# 'F. de Jong', 'Gakpo', 'Netherlands', '2–0', 'Qatar', 'Al Bayt Stadium', ', ', 'Al Khor', 'Attendance: 66,784', 'Referee: ', 'Bakary Gassama']
if choice == "details":
