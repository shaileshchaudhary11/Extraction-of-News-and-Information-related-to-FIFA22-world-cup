...
matches = [list[3]+list[4]+list[5],list[18]+list[19]+list[20],list[28]+list[29]+list[30],list[39]+list[40]+list[41],list[51]+list[52]+list[53],list[65]+list[66]+list[67]]
players = [list[0]+list[1]+list[2],list[12]+list[13]+list[14]+list[15]+list[16]+list[17],list[27],list[37]+list[38],list[48]+list[49]+list[50],list[60]+list[61]+list[62]+list[63]+list[64]]
details = [list[6]+list[7]+list[8]+list[9]+list[10]+list[11],list[21]+list[22]+list[23]+list[24]+list[25]+list[26],list[31]+list[32]+list[33]+list[34]+list[35]+list[36],list[42]+list[43]+list[44]+list[45]+list[46]+list[47],list[54]+list[55]+list[56]+list[57]+list[58]+list[59],list[68]+list[69]+list[70]+list[71]+list[72]+list[73]]

# ['Gündoğan', 'Asano', 'Dōan', 'Germany', '1–2', 'Japan', 'Khalifa International Stadium', ', ', 'Al Rayyan', 'Attendance: 42,608', 'Referee: ', 'Iván Barton',||11

#  'Morata', 'Soler', 'Gavi', 'F. Torres', 'Asensio', 'Olmo', 'Spain', '7–0', 'Costa Rica', 'Al Thumama Stadium', ', ', 'Doha', 'Attendance: 40,013', 'Referee: ', 'Mohammed Abdulla Hassan Mohamed',||26

#  'Fuller', 'Japan', '0–1', 'Costa Rica', 'Ahmad bin Ali Stadium', ', ', 'Al Rayyan', 'Attendance: 41,479', 'Referee: ', 'Michael Oliver',||36

#  'Morata', 'Füllkrug', 'Spain', '1–1', 'Germany', 'Al Bayt Stadium', ', ', 'Al Khor', 'Attendance: 68,895', 'Referee: ', 'Danny Makkelie',||47
 
# 'Tanaka', 'Dōan', 'Morata', 'Japan', '2–1', 'Spain', 'Khalifa International Stadium', ', ', 'Al Rayyan', 'Attendance: 44,851', 'Referee: ', 'Victor Gomes',||59

#  'Vargas', 'Tejeda', 'Füllkrug', 'Havertz', 'Gnabry', 'Costa Rica', '2–4', 'Germany', 'Al Bayt Stadium', ', ', 'Al Khor', 'Attendance: 67,054', 'Referee: ', 'Stéphanie Frappart']
