...
matches = [list[1]+list[2]+list[3],list[11]+list[12]+list[13],list[26]+list[27]+list[28],list[36]+list[37]+list[38],list[50]+list[51]+list[52],list[60]+list[61]+list[62]]
players = [list[0],list[10],list[20]+list[21]+list[22]+list[23]+list[24]+list[25],list[35],list[45]+list[46]+list[47]+list[48]+list[49],list[59]]
details = [list[4]+list[5]+list[6]+list[7]+list[8]+list[9],list[14]+list[15]+list[16]+list[17]+list[18]+list[19],list[29]+list[30]+list[31]+list[32]+list[33]+list[34],list[39]+list[40]+list[41]+list[42]+list[43]+list[44],list[53]+list[54]+list[55]+list[56]+list[57]+list[58],list[63]+list[64]+list[65]+list[66]+list[67]+list[68]]

# ['Embolo', 'Switzerland', '1–0', 'Cameroon', 'Al Janoub Stadium', ', ', 'Al Wakrah', 'Attendance: 39,089', 'Referee: ', 'Facundo Tello',||9

#  'Richarlison', 'Brazil', '2–0', 'Serbia', 'Lusail Stadium', ', ', 'Lusail', 'Attendance: 88,103', 'Referee: ', 'Alireza Faghani',||19

#  'Choupo-Moting', 'Aboubakar', 'Castelletto', 'A. Mitrović', 'S. Milinković-Savić', 'Pavlović', 'Cameroon', '3–3', 'Serbia', 'Al Janoub Stadium', ', ', 'Al Wakrah', 'Attendance: 39,789', 'Referee: ', 'Mohammed Abdulla Hassan Mohamed',||34

#  'Casemiro', 'Brazil', '1–0', 'Switzerland', 'Stadium 974', ', ', 'Doha', 'Attendance: 43,649', 'Referee: ', 'Iván Barton',||44

#  'Vlahović', 'A. Mitrović', 'Freuler', 'Embolo', 'Shaqiri', 'Serbia', '2–3', 'Switzerland', 'Stadium 974', ', ', 'Doha', 'Attendance: 41,378', 'Referee: ', 'Fernando Rapallini',||58

#  'Aboubakar', 'Cameroon', '1–0', 'Brazil', 'Lusail Stadium', ', ', 'Lusail', 'Attendance: 85,986', 'Referee: ', 'Ismail Elfath']
