...
matches = [list[3]+list[4]+list[5],list[12]+list[13]+list[14],list[23]+list[24]+list[25],list[34]+list[35]+list[36],list[45]+list[46]+list[47],list[57]+list[58]+list[59]]
players = [list[0]+list[1]+list[2],"",list[21]+list[22],list[32]+list[33],list[43]+list[44],list[54]+list[55]+list[56]]
details = [list[6]+list[7]+list[8]+list[9]+list[10]+list[11],list[15]+list[16]+list[17]+list[18]+list[19]+list[20],list[26]+list[27]+list[28]+list[29]+list[30]+list[31],list[37]+list[38]+list[39]+list[40]+list[41]+list[42],list[48]+list[49]+list[50]+list[51]+list[52]+list[53],list[60]+list[61]+list[62]+list[63]+list[64]+list[65]]

# ['Messi', 'S. Al-Dawsari', 'Al-Shehri', 'Argentina', '1–2', 'Saudi Arabia', 'Lusail Stadium', ', ', 'Lusail', 'Attendance: 88,012', 'Referee: ', 'Slavko Vinčić',||11 

# 'Mexico', '0–0', 'Poland', 'Stadium 974', ', ', 'Doha', 'Attendance: 39,369', 'Referee: ', 'Chris Beath',||20

#  'Lewandowski', 'Zieliński', 'Poland', '2–0', 'Saudi Arabia', 'Education City Stadium', ', ', 'Al Rayyan', 'Attendance: 44,259', 'Referee: ', 'Wilton Sampaio',||31

#  'Fernández', 'Messi', 'Argentina', '2–0', 'Mexico', 'Lusail Stadium', ', ', 'Lusail', 'Attendance: 88,966', 'Referee: ', 'Daniele Orsato',||42

#  'Álvarez', 'Mac Allister', 'Poland', '0–2', 'Argentina', 'Stadium 974', ', ', 'Doha', 'Attendance: 44,089', 'Referee: ', 'Danny Makkelie',||53

# 'S. Al-Dawsari', 'Chávez', 'Martín', 'Saudi Arabia', '1–2', 'Mexico', 'Lusail Stadium', ', ', 'Lusail', 'Attendance: 84,985', 'Referee: ', 'Michael Oliver']
