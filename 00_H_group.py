...
matches = [list[0]+list[1]+list[2],list[14]+list[15]+list[16],list[26]+list[27]+list[28],list[36]+list[37]+list[38],list[46]+list[47]+list[48],list[58]+list[59]+list[60]]
players = ["",list[9]+list[10]+list[11]+list[12]+list[13],list[23]+list[24]+list[25],list[35],list[45],list[55]+list[56]+list[57]]
details = [list[3]+list[4]+list[5]+list[6]+list[7]+list[8],list[17]+list[18]+list[19]+list[20]+list[21]+list[22],list[29]+list[30]+list[31]+list[32]+list[33]+list[34],list[39]+list[40]+list[41]+list[42]+list[43]+list[44],list[49]+list[50]+list[51]+list[52]+list[53]+list[54],list[61]+list[62]+list[63]+list[64]+list[65]+list[66]]

# ['Uruguay', '0–0', 'South Korea', 'Education City Stadium', ', ', 'Al Rayyan', 'Attendance: 41,663', 'Referee: ', 'Clément Turpin',||8

#  'Leão', 'Félix', 'Ronaldo', 'Bukari', 'A. Ayew', 'Portugal', '3–2', 'Ghana', 'Stadium 974', ', ', 'Doha', 'Attendance: 42,662', 'Referee: ', 'Ismail Elfath',||22

#  'Cho Gue-sung', 'Kudus', 'Salisu', 'South Korea', '2–3', 'Ghana', 'Education City Stadium', ', ', 'Al Rayyan', 'Attendance: 43,983', 'Referee: ', 'Anthony Taylor',||34

#   'Fernandes', 'Portugal', '2–0', 'Uruguay', 'Lusail Stadium', ', ', 'Lusail', 'Attendance: 88,668', 'Referee: ', 'Alireza Faghani',|| 44

#   'De Arrascaeta', 'Ghana', '0–2', 'Uruguay', 'Al Janoub Stadium', ', ', 'Al Wakrah', 'Attendance: 43,443', 'Referee: ', 'Daniel Siebert',||54

#  'Hwang Hee-chan', 'Kim Young-gwon', 'Horta', 'South Korea', '2–1', 'Portugal', 'Education City Stadium', ', ', 'Al Rayyan', 'Attendance: 44,097', 'Referee: ', 'Facundo Tello']
