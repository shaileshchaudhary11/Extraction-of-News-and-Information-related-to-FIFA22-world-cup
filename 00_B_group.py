...
matches = [list[6]+list[7]+list[8],list[17]+list[18]+list[19],list[28]+list[29]+list[30],list[37]+list[38]+list[39],list[48]+list[49]+list[50],list[58]+list[59]+list[60],]
players = [list[0]+list[1]+list[2]+list[3]+list[4]+list[5],list[15]+list[16],list[26]+list[27],"",list[46]+list[47],list[57]]
details = [list[9]+list[10]+list[11]+list[12]+list[13]+list[14],list[20]+list[21]+list[22]+list[23]+list[24]+list[25],list[31]+list[32]+list[33]+list[34]+list[35]+list[36],list[40]+list[41]+list[42]+list[43]+list[44]+list[45],list[51]+list[52]+list[53]+list[54]+list[55]+list[56],list[61]+list[62]+list[63]+list[64]+list[65]+list[66],]

# ['Grealish', 'Rashford', 'Sterling', 'Saka', 'Bellingham', 'Taremi', 'England', '6–2', 'Iran', 'Khalifa International Stadium', ', ', 'Al Rayyan', 'Attendance: 45,334', 'Referee: ', 'Raphael Claus',14||
#  'Weah', 'Bale', 'United States', '1–1', 'Wales', 'Ahmad bin Ali Stadium', ', ', 'Al Rayyan', 'Attendance: 43,418', 'Referee: ', 'Abdulrahman Al-Jassim',25||
#  'Rezaeian', 'Cheshmi', 'Wales', '0–2', 'Iran', 'Ahmad bin Ali Stadium', ', ', 'Al Rayyan', 'Attendance: 40,875', 'Referee: ', 'Mario Escobar',36||
#  'England', '0–0', 'United States', 'Al Bayt Stadium', ', ', 'Al Khor', 'Attendance: 68,463', 'Referee: ', 'Jesús Valenzuela',45||
#  'Foden', 'Rashford', 'Wales', '0–3', 'England', 'Ahmad bin Ali Stadium', ', ', 'Al Rayyan', 'Attendance: 44,297', 'Referee: ', 'Slavko Vinčić',56||
#  'Pulisic', 'Iran', '0–1', 'United States', 'Al Thumama Stadium', ', ', 'Doha', 'Attendance: 42,127', 'Referee: ', 'Antonio Mateu Lahoz']
