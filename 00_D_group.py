...
matches = [list[0]+list[1]+list[2],list[13]+list[14]+list[15],list[23]+list[24]+list[25],list[34]+list[35]+list[36],list[44]+list[45]+list[46],list[54]+list[55]+list[56]]
players = ["",list[9]+list[10]+list[11]+list[12],list[22],list[32]+list[33],list[43],list[53]]
details = [list[3]+list[4]+list[5]+list[6]+list[7]+list[8],list[16]+list[17]+list[18]+list[19]+list[20]+list[21],list[26]+list[27]+list[28]+list[29]+list[30]+list[31],list[37]+list[38]+list[39]+list[40]+list[41]+list[42],list[47]+list[48]+list[49]+list[50]+list[51]+list[52],list[57]+list[58]+list[59]+list[60]+list[61]+list[62]]

# ['Denmark', '0–0', 'Tunisia', 'Education City Stadium', ', ', 'Al Rayyan', 'Attendance: 42,925', 'Referee: ', 'César Arturo Ramos',||8

#  'Mbappé', 'Giroud', 'Rabiot', 'Goodwin', 'France', '4–1', 'Australia', 'Al Janoub Stadium', ', ', 'Al Wakrah', 'Attendance: 40,875', 'Referee: ', 'Victor Gomes',||21

#  'Duke', 'Tunisia', '0–1', 'Australia', 'Al Janoub Stadium', ', ', 'Al Wakrah', 'Attendance: 41,823', 'Referee: ', 'Daniel Siebert',|| 31

# 'Mbappé', 'A. Christensen', 'France', '2–1', 'Denmark', 'Stadium 974', ', ', 'Doha', 'Attendance: 42,860', 'Referee: ', 'Szymon Marciniak',||42

#  'Leckie', 'Australia', '1–0', 'Denmark', 'Al Janoub Stadium', ', ', 'Al Wakrah', 'Attendance: 41,232', 'Referee: ', 'Mustapha Ghorbal',||52

#  'Khazri', 'Tunisia', '1–0', 'France', 'Education City Stadium', ', ', 'Al Rayyan', 'Attendance: 43,627', 'Referee: ', 'Matthew Conger']
